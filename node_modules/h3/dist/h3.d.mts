 ...
 */
type NormalizedRouteRules = { [K in RouteRuleName]?: ResolvedRouteRules[K] | RuleReset<K>; } & {
  [key: string]: unknown;
};
...
interface MatchedRouteRule<K extends RouteRuleName = RouteRuleName> {
...
type MatchedRouteRules = { [K in RouteRuleName]?: MatchedRouteRule<K>; };
/** Builds middleware for a matched rule. */
interface RuleHandler<K extends RouteRuleName = RouteRuleName> {
  /**
...
type RuleHandlers = Record<string, RuleHandler<any> | undefined>;
 ...
 * narrowing.
 */
type ResolvedRouteRules = RouteRules & Omit<BuiltinRouteRules, keyof RouteRules>;
...
type H3 = H3$1;
export { BuiltinRouteRules, CacheRuleOptions, ComposedMiddleware, type CookieSerializeOptions, CorsOptions, DynamicEventHandler, ErrorBody, ErrorDetails, ErrorInput, EventHandler, EventHandlerFetch, EventHandlerObject, EventHandlerRequest, EventHandlerResponse, EventHandlerWithFetch, FetchHandler$1 as FetchHandler, FetchableObject, H3, H3$1, H3Config, H3Core, H3CoreConfig, H3Event, H3EventContext, H3Plugin, H3Route, H3RouteMeta, HTTPError, HTTPEvent, HTTPHandler, HTTPMethod, HTTPResponse, HTTPStatus, InferEventInput, LazyEventHandler, MatchResult, MatchedRoute, MatchedRouteRule, MatchedRouteRules, MaybePromise, Middleware, MiddlewareOptions, NormalizedRouteRules, PreparedResponse, ProxyOptions, ProxyRuleOptions, RedirectRuleOptions, ResolvedRouteRules, RouteOptions, RouteRuleConfig, RouteRules, RouterContext, RuleHandler, RuleHandlers, Session, SessionConfig, SessionData, SessionManager, type TypedRequest, TypedServerRequest, appendCorsHeaders, appendCorsPreflightHeaders, callMiddleware, clearSession, composeMiddleware, defineMiddleware, definePlugin, fetchWithEvent, getProxyRequestHeaders, getSession, handleCors, isCorsOriginAllowed, isPreflightRequest, proxy, proxyRequest, sealSession, toMiddleware, toResponse, unsealSession, updateSession, useSession };