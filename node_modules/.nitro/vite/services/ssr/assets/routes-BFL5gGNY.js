...
var Bunny = memo(BunnyImpl, bunnyPropsAreEqual);
//#endregion
...
var Background = memo(BackgroundImpl);
...
var Dialogue = memo(DialogueImpl);
function CrownGlowImpl({ active }) {
	const sparkCount = useIsMobile() ? 9 : 14;
	const sparks = useMemo(() => Array.from({ length: sparkCount }, (_, i) => {
...
var CrownGlow = memo(CrownGlowImpl);
//#endregion
...
var VideoScene = forwardRef(function VideoScene({ active, onComplete, onEnded, frameMaxHVh = 75, frameBottomVh = 3 }, ref) {
	...
	const endHoldTimer = useRef(null);
	...
	const videoNode = /* @__PURE__ */ jsx("video", {
		ref: videoRef,
	...
	const unmuteButton = isMuted && (stage === "playing" || stage === "buffering") && /* @__PURE__ */ jsxs("button", {
		type: "button",
	...
	return createPortal(/* @__PURE__ */ jsxs(Fragment, { children: [videoNode, unmuteButton] }), document.body);
});
//#endregion
...
function App() {
	...
	const resolvedRef = useRef(resolveTimeline(0));
	const [resolved, setResolved] = useState(resolvedRef.current);
	...
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(AnimatePresence, { children: phase === "wave" && /* @__PURE__ */ jsx(motion.div, {
